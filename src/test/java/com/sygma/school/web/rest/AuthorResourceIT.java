...
import com.sygma.school.domain.Author;
import com.sygma.school.repository.AuthorRepository;
import com.sygma.school.service.AuthorService;
...
public class AuthorResourceIT {
    ...
    public void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getCountryName()).isEqualTo(DEFAULT_COUNTRY_NAME);
    }
    ...
    public void updateAuthor() throws Exception {
        ...
        Author testAuthor = authorList.get(authorList.size() - 1);
        assertThat(testAuthor.getCountryName()).isEqualTo(UPDATED_COUNTRY_NAME);
    }
